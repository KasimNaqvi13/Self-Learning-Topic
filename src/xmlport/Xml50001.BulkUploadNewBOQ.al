// xmlport 50001 "Bulk Upload New BOQ"
// {
//     Caption = 'Import Bulk VO';
//     Format = VariableText;
//     Direction = Import;
//     TextEncoding = UTF8;
...
//                     trigger OnAfterAssignField()
//                     begin
//                         "Vo Collection".Validate("CIT Variation Type", "Vo Collection"."CIT Variation Type"::"New BOQ");
//                     end;
//                 }
...
//                 {
//                 }
//                 fieldelement(CITCustomerBOQNo; "Vo Collection"."CIT Customer BOQ No.")
//                 {
//                 }
//                 // fieldelement(CITBOQDescription; BOQDescriptionText)
//                 // {
//                 //     // Dragon Blob
//                 // }
//                 fieldelement(CITJobTaskDescription; "Vo Collection"."CIT Job Task Description")
//                 {
//                     trigger OnAfterAssignField()
//                     var
//                         OutStream: OutStream;
//                     begin
//                         "Vo Collection"."CIT BOQ Description".CreateOutStream(OutStream, TEXTENCODING::UTF8);
//                         OutStream.Write("Vo Collection"."CIT Job Task Description");
//                     end;
//                 }
...
//                 {
//                 }
//                 fieldelement(CITCustomerBOQUOM; "Vo Collection"."CIT Customer BOQ UOM")
//                 {
//                 }
//                 // fieldelement(TaskUnitPrice; "Vo Collection"."Task Unit Price")
//                 // {
//                 // }
//                 fieldelement(CITQuantity; "Vo Collection"."CIT Quantity")
//                 {
//                 }
//                 fieldelement(CITVOBillingType; "Vo Collection"."CIT VO Billing Type")
//                 {
//                 }
//                 fieldelement(CITPriceDefinitionCode; "Vo Collection"."CIT Price Definition Code")
//                 {
//                 }
//                 fieldelement(CITHandlingCharges; "Vo Collection"."CIT Handling Charges")
//                 {
//                 }
//                 fieldelement(CITReferenceTaskNo; "Vo Collection"."CIT Reference Task No.")
//                 {
//                 }
//                 fieldelement(CITGlobalDimension1Code; "Vo Collection"."CIT Global Dimension 1 Code")
//                 {
//                 }
//                 fieldelement(CITGlobalDimension2Code; "Vo Collection"."CIT Global Dimension 2 Code")
//                 {
//                 }
